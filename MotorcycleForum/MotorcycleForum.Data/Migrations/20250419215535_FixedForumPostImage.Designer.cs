...
namespace MotorcycleForum.Data.Migrations
{
    ...
    [Migration("20250419215535_FixedForumPostImage")]
    partial class FixedForumPostImage
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("MotorcycleForum.Data.Entities.Forum.Comment", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Content = "<3",
                            CreatedDate = new DateTime(2025, 4, 19, 21, 55, 34, 854, DateTimeKind.Utc).AddTicks(9978),
            ...
            modelBuilder.Entity("MotorcycleForum.Data.Entities.Forum.ForumPost", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2025, 4, 19, 21, 55, 34, 854, DateTimeKind.Utc).AddTicks(9955),
                            Downvotes = 0,
            ...
            modelBuilder.Entity("MotorcycleForum.Data.Entities.Forum.ForumTopic", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2025, 4, 19, 21, 55, 34, 854, DateTimeKind.Utc).AddTicks(9929),
                            IsApproved = true,
                        ...
                        new
                        {
                            TopicId = 2,
                            CreatedById = new Guid("f23a5f6d-1c7b-4a5b-97eb-08dbf6a6c3f8"),
                            CreatedDate = new DateTime(2025, 4, 19, 21, 55, 34, 854, DateTimeKind.Utc).AddTicks(9932),
                            IsApproved = true,
                        ...
                        new
                        {
                            TopicId = 3,
                            CreatedById = new Guid("f23a5f6d-1c7b-4a5b-97eb-08dbf6a6c3f8"),
                            CreatedDate = new DateTime(2025, 4, 19, 21, 55, 34, 854, DateTimeKind.Utc).AddTicks(9934),
                            IsApproved = true,
            ...
            modelBuilder.Entity("MotorcycleForum.Data.Entities.Marketplace.MarketplaceListing", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CategoryId = new Guid("d5b06706-b7ed-4252-a257-57b6c4117968"),
                            CreatedDate = new DateTime(2025, 4, 19, 21, 55, 34, 855, DateTimeKind.Utc).AddTicks(32),
                        ...
                        new
                        {
                            ...
                            CategoryId = new Guid("34080d33-7073-48ae-87ee-03c8990ff696"),
                            CreatedDate = new DateTime(2025, 4, 19, 21, 55, 34, 855, DateTimeKind.Utc).AddTicks(36),
            ...
            modelBuilder.Entity("MotorcycleForum.Data.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            RegistrationDate = new DateTime(2025, 4, 19, 21, 55, 34, 854, DateTimeKind.Utc).AddTicks(9627),
                        ...
                        new
                        {
                            ...
                            RegistrationDate = new DateTime(2025, 4, 19, 21, 55, 34, 854, DateTimeKind.Utc).AddTicks(9710),
