...
namespace MotorcycleForum.Data.Migrations
{
    ...
    [Migration("20250423003115_shtesilapam")]
    partial class shtesilapam
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("MotorcycleForum.Data.Entities.Forum.Comment", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Content = "<3",
                            CreatedDate = new DateTime(2025, 4, 23, 0, 31, 15, 195, DateTimeKind.Utc).AddTicks(5579),
            ...
            modelBuilder.Entity("MotorcycleForum.Data.Entities.Forum.ForumPost", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2025, 4, 23, 0, 31, 15, 195, DateTimeKind.Utc).AddTicks(5559),
                            Downvotes = 0,
            ...
            modelBuilder.Entity("MotorcycleForum.Data.Entities.Marketplace.MarketplaceListing", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CategoryId = new Guid("d5b06706-b7ed-4252-a257-57b6c4117968"),
                            CreatedDate = new DateTime(2025, 4, 23, 0, 31, 15, 195, DateTimeKind.Utc).AddTicks(5629),
                        ...
                        new
                        {
                            ...
                            CategoryId = new Guid("34080d33-7073-48ae-87ee-03c8990ff696"),
                            CreatedDate = new DateTime(2025, 4, 23, 0, 31, 15, 195, DateTimeKind.Utc).AddTicks(5634),
            ...
            modelBuilder.Entity("MotorcycleForum.Data.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            RegistrationDate = new DateTime(2025, 4, 23, 0, 31, 15, 195, DateTimeKind.Utc).AddTicks(5295),
                        ...
                        new
                        {
                            ...
                            RegistrationDate = new DateTime(2025, 4, 23, 0, 31, 15, 195, DateTimeKind.Utc).AddTicks(5373),
