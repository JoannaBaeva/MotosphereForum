...
namespace MotorcycleForum.Data.Migrations
{
    ...
    [Migration("20250420120859_SeedEvents")]
            ...
            modelBuilder.Entity("MotorcycleForum.Data.Entities.Event_Tracker.Event", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            EventId = new Guid("c5ce8a8c-eba0-43b2-a747-a07440ccf7b0"),
                            CategoryId = new Guid("9eae427f-4376-493b-a662-c1060dc6d30b"),
                            CreatedDate = new DateTime(2025, 4, 28, 12, 8, 58, 278, DateTimeKind.Utc).AddTicks(2228),
                            Description = "Join us for a big spring motorcycle meetup at the central park!",
                            EventDate = new DateTime(2025, 4, 30, 12, 8, 58, 278, DateTimeKind.Utc).AddTicks(2217),
                            IsApproved = true,
                        ...
                        new
                        {
                            EventId = new Guid("0c31488a-8864-4b6e-8680-d756f3348db4"),
                            CategoryId = new Guid("85a66af6-084e-46ed-beb4-9b3062b17dc6"),
                            CreatedDate = new DateTime(2025, 4, 15, 12, 8, 58, 278, DateTimeKind.Utc).AddTicks(2233),
                            Description = "Learn the basics of motorcycle maintenance and repair from experienced mechanics!",
                            EventDate = new DateTime(2025, 5, 10, 12, 8, 58, 278, DateTimeKind.Utc).AddTicks(2232),
                            IsApproved = true,
            ...
            modelBuilder.Entity("MotorcycleForum.Data.Entities.Forum.Comment", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Content = "<3",
                            CreatedDate = new DateTime(2025, 4, 20, 12, 8, 58, 278, DateTimeKind.Utc).AddTicks(2078),
            ...
            modelBuilder.Entity("MotorcycleForum.Data.Entities.Forum.ForumPost", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2025, 4, 20, 12, 8, 58, 278, DateTimeKind.Utc).AddTicks(2058),
                            Downvotes = 0,
            ...
            modelBuilder.Entity("MotorcycleForum.Data.Entities.Forum.ForumTopic", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2025, 4, 20, 12, 8, 58, 278, DateTimeKind.Utc).AddTicks(2026),
                            IsApproved = true,
                        ...
                        new
                        {
                            TopicId = 2,
                            CreatedById = new Guid("f23a5f6d-1c7b-4a5b-97eb-08dbf6a6c3f8"),
                            CreatedDate = new DateTime(2025, 4, 20, 12, 8, 58, 278, DateTimeKind.Utc).AddTicks(2029),
                            IsApproved = true,
                        ...
                        new
                        {
                            TopicId = 3,
                            CreatedById = new Guid("f23a5f6d-1c7b-4a5b-97eb-08dbf6a6c3f8"),
                            CreatedDate = new DateTime(2025, 4, 20, 12, 8, 58, 278, DateTimeKind.Utc).AddTicks(2031),
                            IsApproved = true,
            ...
            modelBuilder.Entity("MotorcycleForum.Data.Entities.Marketplace.MarketplaceListing", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CategoryId = new Guid("d5b06706-b7ed-4252-a257-57b6c4117968"),
                            CreatedDate = new DateTime(2025, 4, 20, 12, 8, 58, 278, DateTimeKind.Utc).AddTicks(2138),
                        ...
                        new
                        {
                            ...
                            CategoryId = new Guid("34080d33-7073-48ae-87ee-03c8990ff696"),
                            CreatedDate = new DateTime(2025, 4, 20, 12, 8, 58, 278, DateTimeKind.Utc).AddTicks(2143),
            ...
            modelBuilder.Entity("MotorcycleForum.Data.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            RegistrationDate = new DateTime(2025, 4, 20, 12, 8, 58, 278, DateTimeKind.Utc).AddTicks(1572),
                        ...
                        new
                        {
                            ...
                            RegistrationDate = new DateTime(2025, 4, 20, 12, 8, 58, 278, DateTimeKind.Utc).AddTicks(1713),
