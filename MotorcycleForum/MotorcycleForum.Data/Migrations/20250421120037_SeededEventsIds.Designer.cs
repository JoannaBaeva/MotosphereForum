...
namespace MotorcycleForum.Data.Migrations
{
    ...
    [Migration("20250421120037_SeededEventsIds")]
    partial class SeededEventsIds
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("MotorcycleForum.Data.Entities.Event_Tracker.Event", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2025, 4, 26, 12, 0, 36, 648, DateTimeKind.Utc).AddTicks(6130),
                            Description = "Join us for a big spring motorcycle meetup at the central park!",
                            EventDate = new DateTime(2025, 5, 23, 12, 0, 36, 648, DateTimeKind.Utc).AddTicks(6122),
                            IsApproved = true,
                        ...
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2025, 3, 17, 12, 0, 36, 648, DateTimeKind.Utc).AddTicks(6134),
                            Description = "Learn the basics of motorcycle maintenance and repair from experienced mechanics!",
                            EventDate = new DateTime(2025, 4, 1, 12, 0, 36, 648, DateTimeKind.Utc).AddTicks(6133),
                            IsApproved = true,
            ...
            modelBuilder.Entity("MotorcycleForum.Data.Entities.Forum.Comment", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Content = "<3",
                            CreatedDate = new DateTime(2025, 4, 21, 12, 0, 36, 648, DateTimeKind.Utc).AddTicks(5996),
            ...
            modelBuilder.Entity("MotorcycleForum.Data.Entities.Forum.ForumPost", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2025, 4, 21, 12, 0, 36, 648, DateTimeKind.Utc).AddTicks(5974),
                            Downvotes = 0,
            ...
            modelBuilder.Entity("MotorcycleForum.Data.Entities.Marketplace.MarketplaceListing", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CategoryId = new Guid("d5b06706-b7ed-4252-a257-57b6c4117968"),
                            CreatedDate = new DateTime(2025, 4, 21, 12, 0, 36, 648, DateTimeKind.Utc).AddTicks(6048),
                        ...
                        new
                        {
                            ...
                            CategoryId = new Guid("34080d33-7073-48ae-87ee-03c8990ff696"),
                            CreatedDate = new DateTime(2025, 4, 21, 12, 0, 36, 648, DateTimeKind.Utc).AddTicks(6054),
            ...
            modelBuilder.Entity("MotorcycleForum.Data.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            RegistrationDate = new DateTime(2025, 4, 21, 12, 0, 36, 648, DateTimeKind.Utc).AddTicks(5690),
                        ...
                        new
                        {
                            ...
                            RegistrationDate = new DateTime(2025, 4, 21, 12, 0, 36, 648, DateTimeKind.Utc).AddTicks(5775),
